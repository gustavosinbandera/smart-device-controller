...
/* ota type struct mgos_config_ota */
struct mgos_config_ota {
  const char * job_id;
  const char * fw_version;
  int http_ota_timeout_sec;
...
static inline bool mgos_config_ota_parse(struct mg_str json, struct mgos_config_ota *cfg) {
  mgos_config_ota_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_ota_get_schema(), cfg);
}
bool mgos_config_ota_parse_f(const char *fname, struct mgos_config_ota *cfg);
static inline bool mgos_config_ota_emit(const struct mgos_config_ota *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_ota_get_schema(), pretty, out);
}
static inline bool mgos_config_ota_emit_f(const struct mgos_config_ota *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_ota_get_schema(), pretty, fname);
}
static inline bool mgos_config_ota_copy(const struct mgos_config_ota *src, struct mgos_config_ota *dst) {
  return mgos_conf_copy(mgos_config_ota_get_schema(), src, dst);
}
static inline void mgos_config_ota_free(struct mgos_config_ota *cfg) {
  return mgos_conf_free(mgos_config_ota_get_schema(), cfg);
}
...
/* device.fw_version */
#define MGOS_CONFIG_HAVE_DEVICE_FW_VERSION
#define MGOS_SYS_CONFIG_HAVE_DEVICE_FW_VERSION
const char * mgos_config_get_device_fw_version(const struct mgos_config *cfg);
const char * mgos_config_get_default_device_fw_version(void);
static inline const char * mgos_sys_config_get_device_fw_version(void) { return mgos_config_get_device_fw_version(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_device_fw_version(void) { return mgos_config_get_default_device_fw_version(); }
void mgos_config_set_device_fw_version(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_device_fw_version(const char * v) { mgos_config_set_device_fw_version(&mgos_sys_config, v); }
...
/* ota */
#define MGOS_CONFIG_HAVE_OTA
#define MGOS_SYS_CONFIG_HAVE_OTA
const struct mgos_config_ota *mgos_config_get_ota(const struct mgos_config *cfg);
static inline const struct mgos_config_ota *mgos_sys_config_get_ota(void) { return mgos_config_get_ota(&mgos_sys_config); }

/* ota.job_id */
#define MGOS_CONFIG_HAVE_OTA_JOB_ID
#define MGOS_SYS_CONFIG_HAVE_OTA_JOB_ID
const char * mgos_config_get_ota_job_id(const struct mgos_config *cfg);
const char * mgos_config_get_default_ota_job_id(void);
static inline const char * mgos_sys_config_get_ota_job_id(void) { return mgos_config_get_ota_job_id(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_ota_job_id(void) { return mgos_config_get_default_ota_job_id(); }
void mgos_config_set_ota_job_id(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_ota_job_id(const char * v) { mgos_config_set_ota_job_id(&mgos_sys_config, v); }

/* ota.fw_version */
#define MGOS_CONFIG_HAVE_OTA_FW_VERSION
#define MGOS_SYS_CONFIG_HAVE_OTA_FW_VERSION
const char * mgos_config_get_ota_fw_version(const struct mgos_config *cfg);
const char * mgos_config_get_default_ota_fw_version(void);
static inline const char * mgos_sys_config_get_ota_fw_version(void) { return mgos_config_get_ota_fw_version(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_ota_fw_version(void) { return mgos_config_get_default_ota_fw_version(); }
void mgos_config_set_ota_fw_version(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_ota_fw_version(const char * v) { mgos_config_set_ota_fw_version(&mgos_sys_config, v); }

/* ota.http_ota_timeout_sec */
#define MGOS_CONFIG_HAVE_OTA_HTTP_OTA_TIMEOUT_SEC
#define MGOS_SYS_CONFIG_HAVE_OTA_HTTP_OTA_TIMEOUT_SEC
int mgos_config_get_ota_http_ota_timeout_sec(const struct mgos_config *cfg);
int mgos_config_get_default_ota_http_ota_timeout_sec(void);
static inline int mgos_sys_config_get_ota_http_ota_timeout_sec(void) { return mgos_config_get_ota_http_ota_timeout_sec(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_ota_http_ota_timeout_sec(void) { return mgos_config_get_default_ota_http_ota_timeout_sec(); }
void mgos_config_set_ota_http_ota_timeout_sec(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_ota_http_ota_timeout_sec(int v) { mgos_config_set_ota_http_ota_timeout_sec(&mgos_sys_config, v); }

/* ota.commit_timeout_sec */
#define MGOS_CONFIG_HAVE_OTA_COMMIT_TIMEOUT_SEC
#define MGOS_SYS_CONFIG_HAVE_OTA_COMMIT_TIMEOUT_SEC
int mgos_config_get_ota_commit_timeout_sec(const struct mgos_config *cfg);
int mgos_config_get_default_ota_commit_timeout_sec(void);
static inline int mgos_sys_config_get_ota_commit_timeout_sec(void) { return mgos_config_get_ota_commit_timeout_sec(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_ota_commit_timeout_sec(void) { return mgos_config_get_default_ota_commit_timeout_sec(); }
void mgos_config_set_ota_commit_timeout_sec(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_ota_commit_timeout_sec(int v) { mgos_config_set_ota_commit_timeout_sec(&mgos_sys_config, v); }

/* ota.http_max_retries */
#define MGOS_CONFIG_HAVE_OTA_HTTP_MAX_RETRIES
#define MGOS_SYS_CONFIG_HAVE_OTA_HTTP_MAX_RETRIES
int mgos_config_get_ota_http_max_retries(const struct mgos_config *cfg);
int mgos_config_get_default_ota_http_max_retries(void);
static inline int mgos_sys_config_get_ota_http_max_retries(void) { return mgos_config_get_ota_http_max_retries(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_ota_http_max_retries(void) { return mgos_config_get_default_ota_http_max_retries(); }
void mgos_config_set_ota_http_max_retries(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_ota_http_max_retries(int v) { mgos_config_set_ota_http_max_retries(&mgos_sys_config, v); }
